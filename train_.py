...
# Removed sageattention check as it seemed less standard
...
try:
    ...
    from trainer.train_datasets import load_tinystories_dataset # Assuming this exists and works
...
if __name__ == '__main__':
    ...
    config.save_path = "my_transformer_checkpoints" # Specific path for this run
    ...
    try:
        ...
        train_dataset = load_tinystories_dataset(tokenizer, MAX_SEQ_LEN, split="train", max_samples=(config.batch_size * 100),skip_first=1000) # Small sample for test
